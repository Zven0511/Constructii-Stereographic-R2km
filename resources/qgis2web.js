...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3844',
            //extent: [-2806918.089538, -4575899.923780, 434518.147974, 481300.720798],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([428120.323419, 477284.119859, 437037.149257, 480606.074582], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_ConstructiiStereographicR2kmFINAL_2,
    colName: 'type',
    zoom: 10,
    collapsed: true,
    map: map,
